...
<table><%
		...
		if(status==true){
			...
			<%
			Connection con=com.javatpoint.GetCon.getCon();
				...
				Connection con1=com.javatpoint.GetCon.getCon();
				...
				Connection con2=com.javatpoint.GetCon.getCon();
				...
				Connection con3=com.javatpoint.GetCon.getCon();
