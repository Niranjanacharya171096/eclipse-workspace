...
public class P270_ArrayListVsLinkedList {
	/***
	 * Array List - {0, 1, 2, 3, 4, 5, 6} Linked List - [0] > [1] > [2] < < Array
	 * List - When you have to add at the end and remove from the end and getting is
	 * fast Linked List - When you have add at the beginning and remove from the
	 * beginning
	 */
