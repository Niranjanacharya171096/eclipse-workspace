...
public class P104_FilterMapReduceSorted {
  public static void main(String[] args) {
    ...
    int sum1 = nums1.stream().filter(num -> num % 2 == 0) // we can put condition in Predicate(I) and pass reference
        .map(num -> num * 2) // we can put operation in Function(I) and pass reference
