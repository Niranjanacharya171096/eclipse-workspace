...
class chapter86_TreeMapClass_Operations { 
  public static void main(String args[]) { 
    ...
    // Initialization of a TreeMap using Generics 
    TreeMap<Integer, String> tMap4 = new TreeMap<Integer, String>(); 
    ...
    // Initialization of a TreeMap using Generics 
    TreeMap<Integer, String> tMap5 = new TreeMap<Integer, String>(); 
    
    // Inserting the Elements 
    tMap5.put(3, "Geeks"); 
    tMap5.put(2, "For"); 
    tMap5.put(1, "Geeks"); 
    System.out.println("tMap5: " + tMap5); 
