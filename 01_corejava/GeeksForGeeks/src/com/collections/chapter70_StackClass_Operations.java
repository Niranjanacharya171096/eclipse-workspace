...
public class chapter70_StackClass_Operations{ 
  public static void main(String args[]) { 
    //Java program to add elements in a Stack 
    ...
    //Java program to access elements in a Stack 
    ...
    //Java program to remove elements in a Stack  
    // Creating an empty Stack 
