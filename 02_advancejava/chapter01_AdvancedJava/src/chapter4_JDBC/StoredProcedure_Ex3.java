...
public class StoredProcedure_Ex3 {
  public static void main (String [] args) {
    try {
      ...
      CallableStatement cs = con.prepareCall ("{call Stored_Procedure3 (?, ?)}");
      ...
      if (hasResult) {
        ...
        System.out.println("Total Num of students whose percentage is above "+ perc +": " +count);
