...
public class TC002_MarketStockDetails {
  public static void main(String[] args) throws Exception {
    WebDriver driver = DriverSetup.initializeDriver("TC002");
    ...
    List<String> companies = ExcelUtils.readListData(xlpath, sheetName);
