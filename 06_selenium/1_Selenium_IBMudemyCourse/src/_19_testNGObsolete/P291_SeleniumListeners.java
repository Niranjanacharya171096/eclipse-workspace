...
public class P291_SeleniumListeners implements ITestListener, ISuiteListener, IInvokedMethodListener {
	P291_Screenshots scrShot = new P291_Screenshots();
	...
	public void onTestSuccess(ITestResult arg0) {
		...
		WebDriver driver = ((P291_TestNG_TestCase) currentClass).getDriver();
