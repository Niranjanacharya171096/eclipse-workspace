...
public class H21_FindBrokenImages {
  ...
  public static void VerifyBrokenImagesUsingSelenium() throws Exception {
    System.out.println("    VerifyBrokenImagesUsingSelenium();\r\n" + "");
  ...
  public static void VerifyBrokenImagesUsingJsoup() throws Exception {
    System.out.println("    VerifyBrokenImagesUsingJsoup();\r\n" + "");
    Document doc = Jsoup.connect("https://the-internet.herokuapp.com/broken_images").get();
    Elements images = doc.select("img");

    for (Element image : images) {
      String imageSrc = image.attr("src");
      if (!imageSrc.startsWith("http"))
        imageSrc = "https://the-internet.herokuapp.com/" + imageSrc;
      try {
