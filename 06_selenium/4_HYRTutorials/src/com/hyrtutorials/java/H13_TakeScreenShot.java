...
public class H13_TakeScreenShot {
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    H13_StoreScreenshot_FileHandler.CaptureScreenshot(driver, "google.png");

    url = "https://www.facebook.com";
    driver.get(url);

    H13_StoreScreenshot_FileHandler.CaptureScreenshot(driver, "fb.png");
